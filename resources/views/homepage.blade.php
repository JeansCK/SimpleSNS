    ...
    <div class="container py-md-5">
        <div class="row align-items-center">
            <div class="col-lg-7 py-3 py-md-5">
                <h1 class="display-4">Social Media. Clear and Simple.</h1>
                <p class="lead text-muted">Experience social media with clarity. SimpleSNS offers a clean and intuitive
                    interface, making it easy to connect, share, and discover. Less is truly more. Our users have
                    authored {{ $postCount }} posts.</p>
            </div>
